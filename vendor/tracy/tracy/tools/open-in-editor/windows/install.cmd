@echo off
:: This Windows batch file sets open-nav_editor.js as handler for editor:// protocol
...
%reg% ADD HKCR\editor\shell\open\command /ve /d "wscript \"%~dp0open-nav_editor.js\" \"%%1\"" /f
