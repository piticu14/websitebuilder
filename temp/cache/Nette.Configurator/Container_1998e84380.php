<?php
// source: C:\xampp\htdocs\websitebuilder\app/config/config.neon 
// source: C:\xampp\htdocs\websitebuilder\app/config/config.local.neon 

class Container_1998e84380 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\BaseManager' => [1 => ['24_App_Model_Users']],
			'Nette\Object' => [1 => ['24_App_Model_Users']],
			...
			'Nette\Application\UI\Component' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\ComponentModel\Container' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\ComponentModel\Component' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\Application\UI\IRenderable' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\ComponentModel\IContainer' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\ComponentModel\IComponent' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\Application\UI\ISignalReceiver' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'Nette\Application\UI\IStatePersistent' => [['application.1', 'application.2', 'application.3', 'application.5']],
			'ArrayAccess' => [['application.1', 'application.2', 'application.3', 'application.5']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\websitebuilder\app',
			'wwwDir' => 'C:\xampp\htdocs\websitebuilder\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\websitebuilder\app/../temp',
		];
	}


	public function createService__24_App_Model_Users(): App\Model\Users
	{
		$service = new App\Model\Users($this->getService('database.default.context'), $this->getService('security.user'));
		return $service;
	}
	...
	public function createServiceApplication__2(): App\Presenters\BasePresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\websitebuilder\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
		$service->setMapping(['*' => 'App\*Module\Presenters\*Presenter']);
		return $service;
	}


	public function createServiceAuthenticator(): Authenticator
	{
		$service = new Authenticator($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\websitebuilder\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\websitebuilder\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=websitebuilder',
			'piticu', 'C1o9r0v3', null);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_1998e84380 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\websitebuilder\app/../temp/cache/latte');
